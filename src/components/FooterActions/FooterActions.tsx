...
const FooterActions = ({
  ...
  return (
    <View className="flex justify-center bg-black shadow-black pt-8 items-center border-t-slate-200 h-28  absolute bottom-0 right-0 left-0 p-2 rounded-tl-3xl rounded-tr-3xl">
      {isMaxQuestions ? (
        <TouchableOpacity
        ...
        <TouchableOpacity className="space-y-2" onPress={stopRecording}>
          <FastImage
            ...
            source={require('../../../assets/images/active.gif')}
          />
        </TouchableOpacity>
      ) : (
